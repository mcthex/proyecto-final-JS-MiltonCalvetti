//dentro del document ready se agrega la funcion para validar el form
...
function validarDatosContacto() {
    $("#form-contacto").submit(function (e) {
        if ($("#nombre-contacto").val() == "") {
            ...
            // se resetean los campos de entrada
